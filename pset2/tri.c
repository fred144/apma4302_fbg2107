...
{
    Vec x, b, xexact; /*x: what we solve for, b: right-hand side, xexact: exact solution*/
    Mat A;
    ...
    //  make sure to make symmetric positive definitie for the dirichlet boundary conditions by doing Matsetzero
